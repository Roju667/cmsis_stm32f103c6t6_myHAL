...
#define ILI9341_CS_HIGH                                                        \
  md_gpio_write_pin(TFT_CS_GPIO_Port, TFT_CS_Pin, GPIO_PIN_SET)

#define ILI9341_DC_LOW                                                         \
  md_gpio_write_pin(TFT_DC_GPIO_Port, TFT_DC_Pin, GPIO_PIN_RESET)
#define ILI9341_DC_HIGH                                                        \
  md_gpio_write_pin(TFT_DC_GPIO_Port, TFT_DC_Pin, GPIO_PIN_SET)

#define ILI9341_RST_LOW                                                        \
  md_gpio_write_pin(TFT_RST_GPIO_Port, TFT_RST_Pin, GPIO_PIN_RESET)
#define ILI9341_RST_HIGH                                                       \
  md_gpio_write_pin(TFT_RST_GPIO_Port, TFT_RST_Pin, GPIO_PIN_SET)
