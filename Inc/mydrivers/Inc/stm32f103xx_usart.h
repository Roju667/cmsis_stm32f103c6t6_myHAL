...
// @usart_word_lenght
typedef enum usart_word_lenght_t
{
  USART_WORD_LENGHT_8BIT = 0,
  USART_WORD_LENGHT_9BIT
} usart_word_lenght_t;

// @usart_stop_bits
typedef enum usart_stop_bits_t
{
  USART_STOP_BITS_1 = 0,
  USART_STOP_BITS_05,
  USART_STOP_BITS_2,
...
// @usart_error
typedef enum usart_error_t
{
  USART_ERR_NOERR = 0,
  USART_ERR_TIMEOUT_TXE = -100,
...
// @usart_tx_status
typedef enum usart_tx_status_t
{
  USART_TX_IDLE = 0,
  USART_TX_POLLING,
  USART_TX_IRQ,
...
// @usart_rx_status
typedef enum usart_rx_status_t
{
  USART_RX_IDLE = 0,
  USART_RX_POLLING,
  USART_RX_IRQ,
